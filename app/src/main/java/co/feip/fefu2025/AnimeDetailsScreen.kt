...
fun AnimeDetailsScreenPreview() {
    ...
    val sampleRecommendationsData = listOf(
        AnimeData("Атака Титанов", null, "attack_on_titan", listOf("Экшен", "Драма", "Фэнтези"), 2013, 9.0f, 88),
        AnimeData("Наруто: Ураганные хроники", null, "naruto", listOf("Экшен", "Приключения", "Комедия"), 2007, 8.7f, 500),
        AnimeData("One Piece", null, "onepiece", listOf("Экшен", "Приключения", "Комедия", "Фэнтези"), 1999, 8.7f, 1000),
        AnimeData("Магическая битва", null, "jujutsu_kaisen", listOf("Экшен", "Тёмное фэнтези", "Сверхъестественное"), 2020, 8.8f, 47),
        AnimeData("Клинок, рассекающий демонов", null, "demon_slayer", listOf("Экшен", "Тёмное фэнтези", "Исторический"), 2019, 8.9f, 55)
    )
